...
module.exports = (req, res) => {
  try {
    ...
    const faqs = [
      ...
      { q: 'What is Fundamental Value Deviation (FVD)?', a: 'Fundamental Value Deviation measures how far a stock\'s current price is from our AI-estimated fundamental value. A positive FVD means the stock trades above fundamental value (potentially overvalued), while a negative FVD means it trades below (potentially undervalued).' },
